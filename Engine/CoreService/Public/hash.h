...
namespace mark
{
	...
	*/
	...
	public:
		...
		*/
		[[nodiscard]] static uint32_t crc32(const void* data, size_t size, uint32_t initial_value = 0xFFFFFFFFu) noexcept;
		...
		*/
		[[nodiscard]] static uint64_t crc64(const void* data, size_t size, uint64_t initial_value = 0xFFFFFFFFFFFFFFFFu) noexcept;
		...
		*/
		[[nodiscard]] static uint32_t fnv32(const void* data, size_t size, uint32_t initial_value = 2166136261) noexcept;
		...
		*/
		[[nodiscard]] static uint64_t fnv64(const void* data, size_t size, uint64_t initial_value = 14695981039346656037) noexcept;
