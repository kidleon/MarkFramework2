 ...
 */
MARK_BASELIB_C_API HANDLE create_object_pool(
	size_t block_size,
 ...
 */
MARK_BASELIB_C_API void destroy_object_pool(
	HANDLE pool_handle
);
 ...
 */
MARK_BASELIB_C_API void* object_pool_alloc(
	HANDLE pool_handle
);
 ...
 */
MARK_BASELIB_C_API void object_pool_release(
	HANDLE pool_handle,
	void* ptr
);
