...
#define wctrl  STDC_WCTYPE_CONTROL_1
#define wmotn  STDC_WCTYPE_MOTION
#define wspac  STDC_WCTYPE_SPACE_1
#define wpunc  STDC_WCTYPE_PUNCT
#define wdigi  STDC_WCTYPE_DIGIT
#define whexd  STDC_WCTYPE_XDIGIT
#define wlowc  STDC_WCTYPE_LOWER
#define wuppc  STDC_WCTYPE_UPPER
#define wdhex  (STDC_WCTYPE_XDIGIT | STDC_WCTYPE_DIGIT)
#define wlhex  (STDC_WCTYPE_XDIGIT | STDC_WCTYPE_LOWER)
#define wuhex  (STDC_WCTYPE_XDIGIT | STDC_WCTYPE_UPPER)

uint8_t STDC_WCTYPE_MAP[256] =
{
