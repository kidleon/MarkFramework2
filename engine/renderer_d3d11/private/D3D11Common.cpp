...
BOOL D3D11Common::Init() noexcept
{
...
UINT64 D3D11Common::GetUID() noexcept
{
	return interlock_increment_ul64(&CURRENT_UID, MEMORY_ORDER_RELAXED);
}

const RENDER_SETTINGS& D3D11Common::GetRenderSettings() noexcept
{
	return RENDER_SETTINGS_DATA;
}

void D3D11Common::SetRenderSettings(const RENDER_SETTINGS& Settings) noexcept
{
