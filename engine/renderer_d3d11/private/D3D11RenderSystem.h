...
public:
	...
	virtual BOOL CreateTexture1D(const TEXTURE1D_CREATE_DESC& Desc, ITexture1D* pTexture) final;
	virtual BOOL CreateTexture2D(const TEXTURE2D_CREATE_DESC& Desc, ITexture2D* pTexture) final;
