...
public:
	...
	BOOL GetOrCreateRenderPipelineState(
...
private:
	...
	volatile UINT16 m_BlendStateIndex = 0;
	volatile UINT16 m_SamplerStateIndex = 0;
	volatile UINT16 m_RasterizerStateIndex = 0;
	volatile UINT16 m_DepthStencilStateIndex = 0;
	volatile UINT16 m_RenderPipelineStateIndex = 0;
};
