...
RS_RASTERIZER_STATE RS_RASTERIZER_STATE::DEFAULT = { FILL_MODE::SOLID, CULL_MODE::CCW, CONSERVATIVE_RASTER_MODE::OFF, RS_RASTERIZER_STATE::FLAG_DEFAULT, 0, 0.0f, 0.0f };
RS_RASTERIZER_STATE RS_RASTERIZER_STATE::WIREFRAME = { FILL_MODE::WIREFRAME, CULL_MODE::CCW, CONSERVATIVE_RASTER_MODE::OFF, RS_RASTERIZER_STATE::FLAG_DEFAULT, 0, 0.0f, 0.0f };
RS_RASTERIZER_STATE RS_RASTERIZER_STATE::WIREFRAME_TWOSIDE = { FILL_MODE::WIREFRAME, CULL_MODE::NONE, CONSERVATIVE_RASTER_MODE::OFF, RS_RASTERIZER_STATE::FLAG_DEFAULT, 0, 0.0f, 0.0f };
RS_RASTERIZER_STATE RS_RASTERIZER_STATE::TWO_SIDE = { FILL_MODE::SOLID, CULL_MODE::NONE, CONSERVATIVE_RASTER_MODE::OFF, RS_RASTERIZER_STATE::FLAG_DEFAULT, 0, 0.0f, 0.0f };
