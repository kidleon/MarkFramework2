...
*/
MARKENGINE_C_API void init_linked_list(
...
* @param node 추가할 node
*/
MARKENGINE_C_API void linked_list_push_front(
	struct LINKED_LIST* linked_list,
...
* @param node 추가할 node
*/
MARKENGINE_C_API void linked_list_push_back(
	struct LINKED_LIST* linked_list,
	struct LINK_NODE* node
);
...
*/
MARKENGINE_C_API LINK_NODE* linked_list_pop_front(
	struct LINKED_LIST* linked_list
);
...
* @return 반환된 NODE 포인터, 실패시 NULL
*/
MARKENGINE_C_API LINK_NODE* linked_list_pop_back(
	struct LINKED_LIST* linked_list
);
...
* @param node 삽입할 노드
*/
MARKENGINE_C_API void linked_list_insert_node(
	struct LINKED_LIST* linked_list,
...
* @param node 삭제할 노드
*/
MARKENGINE_C_API void linked_list_remove_node(
	struct LINKED_LIST* linked_list,
	struct LINK_NODE* node
);
...
*/
MARKENGINE_C_API void linked_list_sort(
	struct LINKED_LIST* linked_list,
	int (*comp)(void*, void*)
);
