...
* @return 없음
*/
MARKENGINE_C_API void init_srw_lock(srw_lock* lock);
...
* @return 없음
*/
MARKENGINE_C_API void destroy_srw_lock(srw_lock* lock);
...
* @return 없음
*/
MARKENGINE_C_API void lock_read(srw_lock* lock);
...
* @return 없음
*/
MARKENGINE_C_API void unlock_read(srw_lock* lock);
...
* @return 없음
*/
MARKENGINE_C_API void lock_write(srw_lock* lock);
...
* @return 없음
*/
MARKENGINE_C_API void unlock_write(srw_lock* lock);
