...
/**
 * @brief Paged Object Pool을 생성합니다. Paged Object Pool은 고정된 사이즈의 객체를 페이지 단위로 관리하는데 사용됩니다.
 ...
 */
MARKENGINE_C_API HANDLE create_paged_object_pool(
 ...
 */
MARKENGINE_C_API void destroy_paged_object_pool(
	HANDLE pool_handle
);
 ...
 */
MARKENGINE_C_API void* paged_object_pool_alloc(
	HANDLE pool_handle
);
 ...
 */
MARKENGINE_C_API void paged_object_pool_free(
	HANDLE pool_handle,
	void* ptr
);
 ...
 */
MARKENGINE_C_API size_t paged_object_pool_get_used_size(
	HANDLE pool_handle
);
